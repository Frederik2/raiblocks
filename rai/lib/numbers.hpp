...
// SI dividers
rai::uint128_t const Geur_ratio = rai::uint128_t ("1000000000000000000000000000000000"); // 10^33
rai::uint128_t const Meur_ratio = rai::uint128_t ("1000000000000000000000000000000"); // 10^30
rai::uint128_t const keur_ratio = rai::uint128_t ("1000000000000000000000000000"); // 10^27
rai::uint128_t const eur_ratio = rai::uint128_t ("1000000000000000000000000"); // 10^24
rai::uint128_t const meur_ratio = rai::uint128_t ("1000000000000000000000"); // 10^21
rai::uint128_t const ueur_ratio = rai::uint128_t ("1000000000000000000"); // 10^18
