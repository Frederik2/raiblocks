...
extern "C" {
void eur_uint128_to_dec (eur_uint128 source, char * destination)
{
	auto const & number (*reinterpret_cast<rai::uint128_union *> (source));
	strncpy (destination, number.to_string_dec ().c_str (), 32);
}

void eur_uint256_to_string (eur_uint256 source, char * destination)
{
...
void eur_uint512_to_string (eur_uint512 source, char * destination)
{
...
int eur_valid_address (const char * account_a)
{
...
void eur_key_account (const eur_uint256 key, eur_uint256 pub)
{
